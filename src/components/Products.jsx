      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <p className="text-ink/60">
            Every piece below is currently in stock, sizes 12–14. Pick
            a dress, choose your size and quantity, then send it straight to
            our WhatsApp — we'll confirm availability right away.
          </p>
        </div>
        ...
        <p className="text-center text-ink/45 text-sm mt-10">
          Don't see your size or color? Ask us on WhatsApp — new
          stock arrives every week.
        </p>
      </div>
